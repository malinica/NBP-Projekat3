    ...
    const handlePaginateChange = async (page: number, pageSize: number) => {
      ...
      return (
        ...
        <div className={`container-fluid bg-beige p-4`}>
          <div className={`row`}>
            <div className={`col-xxl-3 col-xl-3 col-lg-4 col-md-5 col-sm-12 mb-4 me-4 rounded-3 bg-white shadow p-3`}>
              ...
              <button className={`btn btn-sm my-2 text-white text-center rounded py-2 px-2 ${styles.dugme} ${styles.slova}`} onClick={() => handleSearch()}>Pretraži</button>
            </div>
